        ...
        <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-orange-500 font-medium text-xs uppercase tracking-wide" style={{ fontFamily: 'Product Sans, sans-serif' }}>Origen</span>
              <span className="text-gray-800 font-medium" style={{ fontFamily: 'Product Sans, sans-serif' }}>{data.origin}</span>
            </div>

            <div className="flex flex-col gap-2">
              <span className="text-orange-500 font-medium text-xs uppercase tracking-wide" style={{ fontFamily: 'Product Sans, sans-serif' }}>Destino</span>
              <span className="text-gray-800 font-medium" style={{ fontFamily: 'Product Sans, sans-serif' }}>{data.destination}</span>
            </div>

            <div className="flex flex-col gap-2">
              <span className="text-orange-500 font-medium text-xs uppercase tracking-wide" style={{ fontFamily: 'Product Sans, sans-serif' }}>Estado</span>
              <div>{statusBadge(data.status)}</div>
            </div>

            <div className="flex flex-col gap-2">
              <span className="text-orange-500 font-medium text-xs uppercase tracking-wide" style={{ fontFamily: 'Product Sans, sans-serif' }}>Importancia</span>
              {canEditImportance ? (
                <select
                  value={importance}
                  onChange={e => {
                  ...
                  className="border border-gray-300 rounded-lg px-3 py-2 text-sm bg-white focus:ring-2 focus:ring-orange-400 focus:border-orange-400 outline-none w-fit"
            ...
            {data.description && (
              <div className="col-span-1 md:col-span-2 flex flex-col gap-2">
                <span className="text-orange-500 font-medium text-xs uppercase tracking-wide" style={{ fontFamily: 'Product Sans, sans-serif' }}>Descripción</span>
        ...
        {(data.price || data.pricing_note || data.superadmin_note) && (
          <div className="bg-white rounded-lg p-6 border border-gray-200">
            ...
            <div className="grid grid-cols-1 gap-4 text-sm">
              ...
              {data.price && (
                <div className="flex flex-col gap-2">
                  <span className="text-orange-500 font-medium text-xs uppercase tracking-wide" style={{ fontFamily: 'Product Sans, sans-serif' }}>Precio</span>
              ...
              {data.pricing_note && (
                <div className="flex flex-col gap-2">
                  <span className="text-orange-500 font-medium text-xs uppercase tracking-wide" style={{ fontFamily: 'Product Sans, sans-serif' }}>Nota de Pricing</span>
              ...
              {data.superadmin_note && (
                <div className="flex flex-col gap-2">
                  <span className="text-orange-500 font-medium text-xs uppercase tracking-wide" style={{ fontFamily: 'Product Sans, sans-serif' }}>Nota Super Admin</span>
        ...
        <div className="space-y-4">
          {hasRole('PRICING') && (
            <div className="bg-orange-50 rounded-lg p-6 border border-orange-200">
              <h4 className="text-lg font-semibold text-orange-700 mb-4" style={{ fontFamily: 'Product Sans, sans-serif' }}>Acciones de Pricing</h4>
              <PricingActions
                solicitation={data}
                onRefresh={fetch}
