...
class SilogtranTransform
{
    ...
    {
        return [
            'itesoltra_condicionfacturacion' => 'CON EMISION DE DESPACHO',
            'itesoltra_facturaremesahija'    => 'NO',
            'itesoltra_solounafactura'       => 'NO',
        ];
    }
    ...
    {
        return [
            'itesoltra_condicioncumplido' => 'COMODATO, REMESA',
        ];
    }
