...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\ContentSecurityPolicy::class, // Habilitado para permitir unsafe-eval
    ];
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            // \App\Http\Middleware\MockUserForLocal::class, // ❌ DESACTIVADO - Causaba auto-login no deseado
        ],
        ...
        'api' => [
            ...
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
            \App\Http\Middleware\NormalizeProductCodes::class,
        ],
    ];
